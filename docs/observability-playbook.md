...
| `Hardware Watchdog` **once, at an update** | Benign: nRF54 WDT keeps counting across warm reset; the MCUboot swap can outlast the budget. Self-heals | Nothing (fix candidate: MCUboot `BOOT_WATCHDOG_FEED`) |
